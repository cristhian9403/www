...
<?php       
                           //Aqui el algoritmo para hacer un combobox para los Clientes
							...
							$Documento = "SELECT Documento FROM clientes WHERE Nombre'".$i."'";
...
?>
						...
						<label  class='col-lg-2 control-label'>Documento:</label>
							<div class='col-lg-3'>
								<input type='text' id="precioUnidad0" readonly=true placeholder='Documento' required='required' class='form-control'/>						
							</div>
                    </div>
                    <hr>
